...
class FakeNumericIterator extends
    LazyIterator<[TensorContainer, TensorContainer]> {
  ...
  async next(): Promise<IteratorResult<[TensorContainer, TensorContainer]>> {
...
export class FakeNumericDataset extends
    Dataset<[TensorContainer, TensorContainer]> {
  ...
  async iterator(): Promise<LazyIterator<[TensorContainer, TensorContainer]>> {
