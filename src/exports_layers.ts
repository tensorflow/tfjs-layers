...
import {ELU, ELULayerArgs, LeakyReLU, LeakyReLULayerArgs, PReLU, PReLULayerArgs, ReLU, ReLULayerArgs, Softmax, SoftmaxLayerArgs, ThresholdedReLU, ThresholdedReLULayerArgs,Square,Log} from './layers/advanced_activations';
...
export function square(args?: LayerArgs): Layer {
    return new Square(args);
}


export function log(args?: LayerArgs): Layer {
    return new Log(args);
}
/**
 * @doc {
