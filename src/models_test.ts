...
describeMathCPU('Functional-model saving and loading', () => {
  ...
  it('Load tf2 MobileNet', async () => {
    // This is a serialized model JSON from a functional tf.keras model in
    // 2.0.0-alpha0.
    const modelJSON = JSON.parse(
        // tslint:disable-next-line:max-line-length
        `{"format": "layers-model", "generatedBy": "keras v2.2.4-tf", "convertedBy": "TensorFlow.js Converter v1.0.1", "modelTopology": {"keras_version": "2.2.4-tf", "backend": "tensorflow", "model_config": {"class_name": "Model", "config": {"name": "model", "layers": [{"name": "input_1", "class_name": "InputLayer", "config": {"batch_input_shape": [null, 28, 28, 1], "dtype": "float32", "sparse": false, "name": "input_1"}, "inbound_nodes": []}, {"name": "conv2d", "class_name": "Conv2D", "config": {"name": "conv2d", "trainable": true, "dtype": "float32", "filters": 4, "kernel_size": [2, 2], "strides": [1, 1], "padding": "valid", "data_format": "channels_last", "dilation_rate": [1, 1], "activation": "relu", "use_bias": true, "kernel_initializer": {"class_name": "GlorotUniform", "config": {"seed": null}}, "bias_initializer": {"class_name": "Zeros", "config": {}}, "kernel_regularizer": null, "bias_regularizer": null, "activity_regularizer": null, "kernel_constraint": null, "bias_constraint": null}, "inbound_nodes": [["input_1", 0, 0, {}]]}, {"name": "batch_normalization_v2", "class_name": "BatchNormalization", "config": {"name": "batch_normalization_v2", "trainable": true, "dtype": "float32", "axis": [3], "momentum": 0.99, "epsilon": 0.001, "center": true, "scale": true, "beta_initializer": {"class_name": "Zeros", "config": {}}, "gamma_initializer": {"class_name": "Ones", "config": {}}, "moving_mean_initializer": {"class_name": "Zeros", "config": {}}, "moving_variance_initializer": {"class_name": "Ones", "config": {}}, "beta_regularizer": null, "gamma_regularizer": null, "beta_constraint": null, "gamma_constraint": null}, "inbound_nodes": [["conv2d", 0, 0, {}]]}, {"name": "flatten", "class_name": "Flatten", "config": {"name": "flatten", "trainable": true, "dtype": "float32", "data_format": "channels_last"}, "inbound_nodes": [["batch_normalization_v2", 0, 0, {}]]}, {"name": "dense", "class_name": "Dense", "config": {"name": "dense", "trainable": true, "dtype": "float32", "units": 10, "activation": "softmax", "use_bias": true, "kernel_initializer": {"class_name": "GlorotUniform", "config": {"seed": null}}, "bias_initializer": {"class_name": "Zeros", "config": {}}, "kernel_regularizer": null, "bias_regularizer": null, "activity_regularizer": null, "kernel_constraint": null, "bias_constraint": null}, "inbound_nodes": [["flatten", 0, 0, {}]]}], "input_layers": ["input_1", 0, 0], "output_layers": ["dense", 0, 0]}}}, "weightsManifest": [{"paths": ["group1-shard1of1.bin"], "weights": [{"name": "batch_normalization_v2/gamma", "shape": [4], "dtype": "float32"}, {"name": "batch_normalization_v2/beta", "shape": [4], "dtype": "float32"}, {"name": "batch_normalization_v2/moving_mean", "shape": [4], "dtype": "float32"}, {"name": "batch_normalization_v2/moving_variance", "shape": [4], "dtype": "float32"}, {"name": "conv2d/kernel", "shape": [2, 2, 1, 4], "dtype": "float32"}, {"name": "conv2d/bias", "shape": [4], "dtype": "float32"}, {"name": "dense/kernel", "shape": [2916, 10], "dtype": "float32"}, {"name": "dense/bias", "shape": [10], "dtype": "float32"}]}]}`);
    const model =
        await modelFromJSON(modelJSON['modelTopology']) as tfl.LayersModel;
    ...
    const xs = randomUniform([1, 28, 28, 1]);
    const ys = model.predict(xs) as Tensor;
    expect(ys.shape).toEqual([1, 10]);
  });
});
